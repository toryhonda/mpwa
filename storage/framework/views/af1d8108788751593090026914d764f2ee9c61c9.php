...
<head>
    ...
    <!-- Semantic-UI -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/semantic-ui/semantic.min.2.4.2-' . (in_array(app()->getLocale(), ['ar', 'he', 'fa']) ? 'rtl' : 'ltr') . '.css')); ?>">
    <script type="application/javascript" src="<?php echo e(asset('assets/semantic-ui/semantic.min.2.4.2.js')); ?>"></script>

    <!-- Spacing CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css-spacing/spacing-' . (in_array(app()->getLocale(), ['ar', 'he', 'fa']) ? 'rtl' : 'ltr') . '.css')); ?>">
                    ...
                    <div class="ui fluid card">
                        ...
                        <div class="content body">
                            ...
                            <div class="step general" :class="{ active: stepIsActive(2) }">
                                <div class="field">
                                    <div style="text-align:center;"><b>Source Code di Beli dari :</b></div>
                                    <input id="licensekey" type="hidden" name="licensekey" value="MagdAlmuntaser">
                                </div>

                                <div class="field">
                                    <div style="text-align:center;"><b>www.baguspedia.biz.id</b></div>
                                    <input id="buyeremail" type="hidden" name="buyeremail" value="admin@admin.com">
                                </div>
                            </div>
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                validateLicense: function(e) {
                    ...
                    if (license == '' || email == '') {
                        alert('<?php echo e(__("Please enter license key and email")); ?>')
                        return;
                    }
                    $(e.target).toggleClass('loading', true);
                    $.ajax({
...
<?php /**PATH /www/wwwroot/warmer.wazap.web.id/resources/themes/mpwa/views/install.blade.php ENDPATH**/ ?>